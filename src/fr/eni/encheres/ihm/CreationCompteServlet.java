...
//		request.setAttribute("erreurPseudo", ConnexionForm.regStringValeur(pseudo, "pseudo"));
		...
		// TODO Savoir si un message d'erreur à été levée (Constante ?)
...
//		String confirmMdp = request.getParameter("confirmMdp").trim();
		...
		// TODO regex spécifique au Mdp (nbr de char/ chiffre...)

//		if (!(mdp.contentEquals(confirmMdp))) {
//
//			String messageConfirm = "Le mot de passe et sa confirmation sont diff�rents";
...
//			e.printStackTrace();
//		}
		// TODO Savoir si une un message d'erreur à été créé
		if (!erreur) {
